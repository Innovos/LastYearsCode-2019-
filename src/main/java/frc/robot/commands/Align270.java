...
public class Align270 extends Command {
  ...
  protected void execute() {
    if(angle >= 90 && angle <= 270) { //checks to see if it will take less time to turn left or right
      if(!(angle >= 260)) { //this code is based off the assumption the gyro goes from 0 to 360
